...
function hlwp_preview_link_function() {
    $restNonce = wp_create_nonce( 'hlwp_content_preview' );
    ...
    ?>
        ...
        <div style="padding-top: 10px; float: right; height: 30px;">
            <a href="http://localhost:9001?nonce-token=<?php echo $restNonce ?>" target="_blank" class="button button-primary">Open preview mode</a>
        </div>
